...
## Clock signal
set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33} [get_ports g_clk]
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports g_clk]
...
set_property -dict {PACKAGE_PIN C2 IOSTANDARD LVCMOS33} [get_ports g_nrst_btn]
